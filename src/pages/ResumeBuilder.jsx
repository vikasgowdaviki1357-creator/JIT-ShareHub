  ...
  return (
    <div className="resume-page">
      ...
      <div className="resume-hero">
        ...
        <div className="hero-badge">📄 RESUME BUILDER</div>

        <h1 className="hero-title">Build Your Resume</h1>
        <h2 className="hero-subtitle">Stand out from the crowd.</h2>

        <p className="hero-desc">
          Fill in your details, preview your resume live, and
          download a polished PDF ready for placements.
        </p>
