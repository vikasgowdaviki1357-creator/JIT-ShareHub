    ...
    <div className="chat-page">
      ...
      <div className="chat-container">
        ...
        <div className="chat-hero">
          ...
          <h1 className="hero-title">JIT AI Assistant</h1>
          <h2 className="hero-subtitle">Your smart campus companion.</h2>

          <p className="hero-desc">
            Ask about placements, events, marketplace items,
            resources, or just chat to get instant answers.
          </p>
